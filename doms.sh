export DOMS_ADAPTER_DB_JDBC_URL="jdbc:postgresql://localhost:5430/doms_adapter?user=doms_adapter_user&password=doms_adapter_password"
...
/usr/lib/jvm/jdk-11/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=21040 -jar /home/me/GIT/ferzl/other_services/doms-adapter/target/doms-adapter-null.jar
