...
//		System.out.println(kkResult);
	...
	private static LinkedHashMap<String, String> getAuthMap() {
		...
		map.put("Content-Type", "application/json");
		map.put("User-Agent", USER_AGENT);
		map.put("X-Auth-Token", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzZXNzaW9uLWlkIjoiNTVhYjJmN2YtNWUwMi00N2VlLTkyY2MtNzFhN2UzMDQ3YmM2In0.0F5dtX77wqBAoLB7FswpQ5INwgjv5VhrEgC7S2CBG8Q");
		return map;
	}
