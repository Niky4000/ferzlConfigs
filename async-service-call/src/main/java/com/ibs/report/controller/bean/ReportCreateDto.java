...
public class ReportCreateDto {
    ...
    public ReportCreateDto(OperationType type, String source, String fileType, Boolean createdByManager, List<ReportParameter> parameters) {
        this.type = type;
        this.source = source;
    ...
    public String toPost() {
        StringBuilder sb = new StringBuilder("{\n")
                ...
                .append("    \"createdByManager\": \"").append(createdByManager).append("\"");
