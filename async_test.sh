...
export ASYNC_SERVICE_DB_OLAP_JDBC_URL="jdbc:postgresql://192.168.100.56:5432/mpi_olap_service?currentSchema=public&user=mpi_olap_service_user&password=dMfOl2qtjeBmqwY6Ud59"
...
/usr/lib/jvm/jdk-11/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=21044 -jar /home/me/GIT/ferzl/async-service/target/async-service-0.0.1.jar
