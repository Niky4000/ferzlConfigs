...
export MPI_SERVICE_HOST=https://erzl-test.element-lab.ru
...
export INCIDENT_SERVICE_HOST=https://erzl-test.element-lab.ru
...
/usr/lib/jvm/jdk-11/bin/java -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=21045 -jar /home/me/GIT/ferzl/mpi-reporter/target/mpi-reporter-0.0.1.jar --server.port=8082
