...
export TFOMS_HOST=http://erzl-test.element-lab.ru
export ORGANIZATION_SERVICE_HOST=http://erzl-test.element-lab.ru
export INCIDENT_SERVICE_HOST=http://erzl-test.element-lab.ru
export NSI_SERVICE_NEXT_HOST=http://erzl-test.element-lab.ru
